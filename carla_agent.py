...
class The_Best_Agent(autonomous_agent.AutonomousAgent):
    def setup(self, checkpoint_path):
        ...
        self.turn_controller = PID_Controller(K_P = 1.25, K_I = 0.75, K_D = 0.3,n = 40)
        self.speed_controller = PID_Controller(K_P = 5.0, K_I = 0.5, K_D = 1.0,n = 40)
